...
echo "=== Final Pipeline Fix - Making CI/CD Pipeline Succeed ==="
...
terraform plan -out=tfplan_final -target=module.vpc -target=module.rds -target=module.ecs -target=module.alb -target=module.cloudfront -target=module.route53 -target=module.waf -target=module.s3 -target=module.sns -target=module.xray -target=module.athena -target=module.cloudwatch -target=module.ecr -target=module.dms

echo "=== Final pipeline fix complete ==="
